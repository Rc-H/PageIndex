...
def create_app(
    ...
    service_settings = settings or loaded_settings.service
    resolved_llm_settings = llm_settings or loaded_settings.llm
    configure_logging(
    ...
    index_task_service = task_service or IndexTaskService(service_settings, llm_settings=resolved_llm_settings)
